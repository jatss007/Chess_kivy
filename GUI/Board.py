    ...
    def on_touch_up(self, touch):
        ...
        if res:
            ...
            while index != len(list_of_previous_data) -2:
                ...
                #print("moved",self.piece_that_moved)
                index += 1
